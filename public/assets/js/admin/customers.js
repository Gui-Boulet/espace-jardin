        ...
        switch (typeModal) {
          ...
          case deleteModal:
            ...
            const containerDeleteModal = {
              ...
              'week' : button.getAttribute('data-intervention-week'),
              'idCustomer' : button.getAttribute('data-customer-id')
            }
            ...
            const areaDeleteModal = {
              'id' : typeModal.querySelector('#intervention-id'),
              'name' : typeModal.querySelector('#service-name'),
              'week' : typeModal.querySelector('#intervention-week'),
              'idCustomer' : typeModal.querySelector('#customer-id')
            }
            ...
            areaDeleteModal.idCustomer.value = containerDeleteModal.idCustomer
            break
        }
      }
    )
